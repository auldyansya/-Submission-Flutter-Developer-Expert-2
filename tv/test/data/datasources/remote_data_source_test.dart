...
void main() {
  ...
  setUp(() {
    ...
    dataSource = TvRemoteDataSourceImpl(client: mockSSLPinningClient);
  });
  ...
  group('Get Tv Season detail', () {
    ...
    test('should return tv season detail when the response code is 200', () async {
      // arrange
      when(mockSSLPinningClient.get(Uri.parse('$baseUrl/tv/$tId/season/$tSeason?$apiKey')))
          .thenAnswer((_) async =>
  ...
  group('Get Popular Tv', () {
    ...
    test('should return list of tv when response is success (200)',
            () async {
          // arrange
          when(mockSSLPinningClient.get(Uri.parse('$baseUrl/tv/popular?$apiKey')))
              .thenAnswer((_) async =>
  ...
  group('Get Top Rated Tv', () {
    ...
    test('should return list of tv when response code is 200 ', () async {
      // arrange
      when(mockSSLPinningClient.get(Uri.parse('$baseUrl/tv/top_rated?$apiKey')))
          .thenAnswer((_) async =>
  ...
  group('Get Tv detail', () {
    ...
    test('should return tv detail when the response code is 200', () async {
      // arrange
      when(mockSSLPinningClient.get(Uri.parse('$baseUrl/tv/$tId?$apiKey')))
          .thenAnswer((_) async =>
